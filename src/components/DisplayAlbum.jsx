...
export default function DisplayAlbum() {
    ...
    const { playWithId, showTrackInfo } = useContext(PlayerContext);
    ...
    return (
        <>
            <Navbar />
            <div className={`mt-10 flex gap-8 flex-col md:flex-row md:items-end ${showTrackInfo ? 'mb-24' : ''}`}>
                ...
                <div className="flex flex-col">
                    ...
                    <p className="mt-1">
                        ...
                        <b> Ipetify </b>
                        {/* - 1,234,234 likes */}
                        - <b>{albumSongs.length} canciones, </b>
                        about 2 hr 30 min
                    </p>
                </div>
            </div>
