...
export default function Player() {
    ...
    return (
        <div className="fixed bottom-0 w-full bg-black text-white px-4 py-2">
            {/* Información de la canción, visible arriba en modo móvil */}
            <div className="flex flex-col items-center gap-2 mb-2 lg:hidden">
                ...
                <div className="text-center">
                    ...
                    <p className="text-xs opacity-75">{track.desc.slice(0, 12)}</p>
                </div>
            </div>

            {/* Controles del reproductor */}
            <div className="h-[10%] flex justify-between items-center lg:flex-row flex-col">
                {/* Información de la canción en pantallas grandes, visible a la izquierda */}
